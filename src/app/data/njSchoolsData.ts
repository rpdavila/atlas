...
export const njSchoolsData: SchoolDistrict[] = [
  {
  ...
  },
  {
    ...
    schools: [
      ...
      "Burlington Township Elementary School",
  ...
  },
  {
    ...
    schools: [
      ...
      "Hamilton High School North (Nottingham)",
  ...
  },
  {
    ...
    schools: [
      ...
      "School of Education & Training at JFK",
      "School of Business, Technology, Marketing & Finance at JFK",
      "School of Science, Technology, Engineering & Mathematics at JFK",
      "School of Government & Public Administration at Eastside",
      "School of Culinary Arts, Hospitality & Tourism at Eastside",
      "School of Information Technology at Eastside",
      "Great Falls Academy",
      "YES Academy",
      ...
      "Rev. Dr. Martin Luther King Jr. School",
      "Public School No. 2",
      "Public School No. 3",
      "Public School No. 5",
      "Public School No. 6",
  ...
  },
  {
    ...
    schools: [
      ...
      "Claremont Avenue School",
      "Ford Avenue School",
      "Indiana Avenue School",
      "Kennedy Park School",
      "Lafayette Estates School",
      "Lynn Crest School",
      "Matthew Jago School",
  ...
  },
  {
    ...
    schools: [
      ...
      "Bridgewater-Raritan Intermediate School",
  ...
  },
  {
    ...
    schools: [
      ...
      "Eugenio María de Hostos Elementary School",
      "Hudson School",
  ...
  {
    district: "Irvington Township Public Schools",
    schools: [
  ...
  {
    district: "West Orange Public School District",
    schools: [
  ...
  },
  {
    ...
    schools: [
      ...
      "Sonya Sotomayor Elementary School",
      "Vernon L. Davey Middle School"
    ]
  },
  {
    ...
    schools: [
      "Hoboken High School",
      "A.J. Demarest Elementary School",
  ...
  {
    district: "Bayonne Public Schools",
    schools: [
      "Bayonne High School",
      "Bayonne Middle School",
      "Lincoln Community School",
      "Horace Mann Elementary School",
      "Henry Harris Elementary School",
      "Midtown Community Elementary School",
      "Nicholas Oresko Elementary School",
      "Robinson Elementary School",
