  ...
  return (
    <section className="flex flex-col justify-center items-center min-h-[60vh] bg-slate-100 rounded-lg p-8 shadow-lg border border-slate-600">
      <div className="text-center space-y-8">
        ...
        <div className="bg-slate-100 rounded-lg p-6 space-y-6">
          <h2 className="text-2xl font-semibold text-slate-800 border-b border-slate-600 pb-3">
            Instrument Overview
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-slate1-100 rounded-lg p-4 text-center  border-small border-slate-600">
              <dt className="text-sm font-medium text-slate-800 mb-2">School Wide Available</dt>
              <dd className="text-3xl font-bold text-slate-800">{schoolCount}</dd>
            </div>

            <div className="bg-slate-100 rounded-lg p-4 text-center border-small border-slate-600">
              <dt className="text-sm font-medium text-slate-800 mb-2">District Wide Available</dt>
              <dd className="text-3xl font-bold text-slate-800">{districtCount - schoolCount}</dd>
            </div>
          </div>
        </div>
      </div>
