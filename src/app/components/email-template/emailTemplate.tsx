...
export const EmailTemplate = ({
  ...
  <div>
    ...
    <br />
    <p>I am reaching out to inquire if it would be possible for you to transfer an instrument to support a student who is currently in need. Your assistance would be greatly appreciated and would make a significant difference.</p>
